...
\newcommand{\fincres}{\fcomma{}inc\&res}           % Improves spacing between f,inc&res
...
Thus, Equation~\ref{eq:rebound_2} can be employed to write substitution rebound as
...
Equation~\ref{eq:rebound_2} can be employed for the income and respending rebound effect.
