...
%
\begin{equation} \label{eq:using_gamma}
  p_E - \frac{\dot{C}_{impl}}{\dot{E}_{sav,dev,dir}} 
      = p_E \left( 1 - \frac{\dot{C}_{impl}}{p_E (1 - Re_{dev}) \dot{E}_{sav,dev,dir,expected}} \right) 
...
\label{sec:conditions_for_backfire}
%++++++++++++++++++++++++++++++
