...
This statement\footnote{Not actually a statement} needs referencing \citep{Borenstein:2015aa}. This was described in \cite{Figueredo:2009dg}. This is a reference to a table (Table \ref{tab:example}).
