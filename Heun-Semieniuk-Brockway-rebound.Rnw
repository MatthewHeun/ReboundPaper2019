...
Do you want to amend the discussion below to more fairly represent \Ba{}'s text?
****
...
and an \emph{additional} productivity effect in which $0 \le k < \infty$.
...
It is really a productivity effect with assumed magnitude 1.
