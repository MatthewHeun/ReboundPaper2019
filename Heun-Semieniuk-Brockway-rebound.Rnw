...
the device owner spends freed cash (money left over after purchasing energy services with upgraded devices)
on additional goods, 
...
This idea has also been promulgated by \citet{Gillingham:2015aa}, \citet{Gillingham2016a}, and \citet{Lange2019}, 
who all cite \Ba{}.%
\footnote{
...
We believe the use of the word ``multiplier'' 
is unfortunate in this context for four reasons.
...
**** Is this really a second reason? ---MKH **** 
Second, the ``multiplier effect'' refers to changes in real income
by changing the monetary \emph{income}, 
...
Regardless of their source, these additional funds can mobilize additional resources
and demand more energy, leading to rebound. 
In contrast to the Keynesian multiplier, 
...
existing infrastructure (e.g., refineries) could process the primary energy resource,
...
Indeed, we claim that the macroeconomic effects of energy efficiency are productivity effects,
...
Consider capital productivity: it has risen XX-fold, 
yet YYYY.
And so to with energy.
While energy efficiency at the device-level climbs, energy consumption at the macro level also rises.
...
whether in utilization of capital, 
utilization of labor, or 
