...
Implicitly, then, we are claiming that energy is a factor of production,
alongside capital and labor.%
\footnote{
  In the energy-economy literature, 
  there is a fraught history of including energy as a factor of production
  in aggregate production functions. 
  We think building a bridge from micro to macro is a better route to travel.
  See \citet{Heun:2017} for details.
}
Energy efficiency operates along the supply side by reducing the cost of inputs 
(in this case, final energy)
and thereby allowing production on a greater scale. 
...
\citet{Heun:2019aa} show that increases in aggregate energy efficiency and
increases in aggregate energy consumption go hand-in-hand.
**** Pull numbers from the Ghana UK paper. ****
Of course, this generality between energy on the one hand and capital and labor on the other
...
gained by the device owners at the micro level.
