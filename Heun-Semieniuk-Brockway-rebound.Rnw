...
%++++++++++++++++++++++++++++++
\subsection{Mecroeconomic effects}
...
But the income effect doesn't exist in a vacuum, and most authors 
neglect the fact that the budget constraint applied to the substitution effect at the micro level
also applies at the macro level. 
When a consumer shifts spending away from energy to another portion of the economy,
...
cancels the increased spending by the device owner.
...
**** We may want to combine or separate these rebound effects.
Or add new. 
...
This ***** FS: what is antecedent for ``this?''? ---MKH ****  can lead 
to important and surprising counter tendencies in factor use reduction.
...
yet more capital is in service than ever before. **** Need statistic here. ---MKH ****
...
energy consumption at the macro level also rises.
**** Pull numbers from the Ghana UK paper. ****
Of course, this generality with capital and labor raises the question 
...
gained by the device owner at the micro level.
...
Our approach to capital and disposal costs is similar to our approach to embodied energy, i.e.\
