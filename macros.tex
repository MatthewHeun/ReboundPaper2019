...
% Income rebound
\newcommand{\Reiequation}{( 1 - \gamma) p_{\Ef} I_{\Ef}}

% Income and respending rebound
\newcommand{\Reirequation}{( 1 - \gamma) k p_{\Ef} I_{\Ef}}

% Total rebound
\newcommand{\Retotequation}{Re_{emb} + Re_{dev} + \left( 1 - \frac{Re_{dev}}{k} - \gamma \right) k p_{\Ef} I_{\Ef}}
