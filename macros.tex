...
\newcommand{\Resubequation}{(1 - p_{\Ef} I_{\Ef}) Re_{dev}}

% Income rebound
\newcommand{\Reiequation}{( 1 - \gamma) I_{\Ef} p_{\Ef}}

% Income and respending rebound
\newcommand{\Reirequation}{( 1 - \gamma) k I_{\Ef} p_{\Ef}}

% Total rebound
\newcommand{\Retotequation}{Re_{emb} + Re_{dev} + \left( 1 - \frac{Re_{dev}}{k} - \gamma \right) k I_{\Ef} p_{\Ef}}
