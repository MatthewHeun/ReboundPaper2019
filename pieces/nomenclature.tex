...
\begin{tabular}{r l}
  ...
  $\eqsps$   & compensated energy service price ($p_s$) elasticity of energy service consumption ($\dot{q}_s$) [--] \\
  $\eqops$   & compensated energy service price ($p_s$) elasticity of other goods consumption ($\dot{q}_o$) [--] \\
