...
additional energy service ($\Delta \rainc{q}_s$, $\Delta \rainc{C}_s = p_E \Delta \rainc{E}_s$) and 
...
The budget constraint is represented by Eq.~(\ref{eq:inc_budget_constraint}): 
...
Then set $\eqsM = 1$ and $\eqoM = 1$ due to homotheticity to obtain
