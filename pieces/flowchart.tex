...
\begin{tikzpicture}%[font=\sffamily]
  ...
  % \node[right=0.2cm of prod] (tilde) {$\amacro{~}$};
  ...
  \node[right=0.2cm of bar] (prod)[rounded corners, text=black, fill=macrocolor] {\strut productivity};
  \node[right=0.2cm of prod] (tilde) {$\sim$};
  ...
  \node[below=0.1cm of prod] {$Re_{\macro}$};
