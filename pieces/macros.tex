...
\newcommand{\seg}[4]{#1\linethickness{#3}\raisebox{0.9 mm}{\textcolor{#2}{\line(1,0){12}}}#4}

% Construction lines
\newcommand{\iicirc}{\seg{$\bempl{\text{i}}$}{black}{0.4 mm}{$\bempl{\text{i}}$}}
...
% Line segments
\newcommand{\circa}{\seg{$\circ$}{emplcolor}{1 mm}{a}}
\newcommand{\ab}{\seg{a}{emplcolor}{1 mm}{b}}
\newcommand{\bstar}{\seg{b}{emplcolor}{1 mm}{$*$}}
\newcommand{\starc}{\seg{$*$}{subcolor}{1 mm}{$\,$c}}
\newcommand{\chat}{\seg{c$\,$}{subcolor}{1 mm}{$\wedge$}}
