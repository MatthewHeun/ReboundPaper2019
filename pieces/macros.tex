...
% Construction lines
\newcommand{\ii}{\seg{i}{black}{0.4 mm}{i}}
...
% Line segments
\newcommand{\circone}{\seg{$\circ$}{emplcolor}{1 mm}{1}}
\newcommand{\onetwo}{\seg{1}{emplcolor}{1 mm}{2}}
\newcommand{\twostar}{\seg{2}{emplcolor}{1 mm}{$*$}}
\newcommand{\starfour}{\seg{$*$}{subcolor}{1 mm}{4}}
\newcommand{\fourhat}{\seg{4}{subcolor}{1 mm}{$\wedge$}}
