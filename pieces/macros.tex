...
% Device effect
\newcommand{\deveffect}{\inlinebox[\devcolor]{device upgrade}}
\newcommand{\deveffectadj}{\inlinebox[\devcolor]{device-upgrade}}
\newcommand{\Deveffect}{\inlinebox[\devcolor]{Device upgrade}}
\newcommand{\DevEffect}{\inlinebox[\devcolor]{Device Upgrade}}

% Life cycle effect
\newcommand{\lceffect}{\inlinebox[\lccolor]{life cycle effect}}
\newcommand{\lceffectadj}{\inlinebox[\lccolor]{life-cycle-effect}}
\newcommand{\Lceffect}{\inlinebox[\lccolor]{Life cycle effect}}
\newcommand{\LcEffect}{\inlinebox[\lccolor]{Life cycle Effect}}
...
\newcommand{\Eacctblc}{\radev{E} = \radev{E}_s + \rbdev{E}_{emb} + (\radev{C}_{\OMd} + \radev{C}_o) I_E}
