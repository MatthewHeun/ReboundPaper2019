...
\newcommand{\Eacctaemp}{\raempl{E} = \raempl{E}_s + \raempl{E}_{emb} + (\raempl{C}_{\OMd} + \raempl{C}_o) I_E}                  
\newcommand{\Macctaemp}{\raempl{M} = p_E \raempl{E}_s + \raempl{C}_{cap} + \raempl{C}_{\OMd} + \raempl{C}_o + \raempl{N}}         
