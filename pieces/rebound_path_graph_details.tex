...
\begin{itemize}
  ...
  \item constant expenditure lines in preference path graphs, 
  
  \item rays from the origin to the point between 
        the substitution effect and the income effect ($\wedge$), and 

  \item indifference curves in preference path graphs.
...
\end{equation}
%
Next, we substitution $y$ for $\rate{E}_{indir}$,
...
Equation for \rr{} line.

Equation for indifference curves.
