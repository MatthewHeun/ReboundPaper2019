...
$\rate{q}_s/\rbempl{q}_s$ is the abscissa and 
$\rate{C}_o/\rbempl{C}_o$ is the ordinate gives
...
Recognizing that 
$\rate{C}_o/\rbempl{C}_o$ is on the ordinate and 
$\rate{q}_s/\rbempl{q}_s$ is on the abscissa
