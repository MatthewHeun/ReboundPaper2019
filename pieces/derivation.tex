...
\begin{tabular}{r l}
  ...
  \sout{$\Delta \rainc{C}_{\md}$}        & $\rbinc{C}_{\md} = \rainc{C}_{\md}$ ($\rate{C}_{\md}$ unchanged across income effect.) \\
  \sout{$\rainc{N}$}                     & $\rainc{N} = 0$ (All net income is re-spent in the income effect.) \\
  \bottomrule
\end{tabular}
...
(Appendix~\ref{sec:exogenous_p_o}),
