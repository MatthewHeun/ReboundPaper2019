...
\begin{equation}
  Re_{isub} = \frac{\Delta \rasub{C}_o}{\Sdot} = \frac{(\rasub{C}_o - \rbsub{C}_{o}) I_E}{\Sdot} \; .
\end{equation}
%
Rearranging gives
...
% \end{equation}
% 
% Substituting Eq.~(\ref{eq:N_dot_I_E_Sdot}) into Eq.~(\ref{eq:Re_prod_def}) gives
