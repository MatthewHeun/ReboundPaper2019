...
\begin{equation}
    Re_{dsub} = \frac{\frac{\rasub{q}_s}{\rbsub{q}_s} - 1}{\frac{\aprod{\eta}}{\bempl{\eta}} - 1} \; \;
                \frac{\cancelto{\rbempl{E}_s}{\frac{\rbsub{q}_s}{\bempl{\eta}}}}{\rbdev{E}_s} \; .
\end{equation}
%
Noting that $\frac{\rbsub{q}_s}{\bempl{\eta}} = \frac{\rbdev{q}_s}{\bempl{\eta}} = \rbdev{E}_s$,
...
%
\begin{equation}
  p_o = \frac{\sum\limits_i \bempl{p}_{o,i} \rbdev{q}_{o,i}}{\sum\limits_i \rbdev{q}_{o,i}} \; .
\end{equation}
%
...
\begin{equation}
  Re_{dinc} = \frac{\left[ \left( 1 + \frac{\rbinc{N}}{\rbdev{M}} \right) ^{\epsilon_{dinc}} - 1  \right] 
                ...
                \cancel{\rbdev{E}_s}}
              {\left( \frac{\aprod{\eta}}{\bempl{\eta}} - 1 \right)\! \cancel{\frac{\bempl{\eta}}{\aprod{\eta}}} \cancel{\rbdev{E}_s}} \; .
\end{equation}
%
