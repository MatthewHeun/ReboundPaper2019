...
The emplacement effect accounts for emplacing the device in service.
No behavior changes occur.
The direct effect of the EEU is energy savings and energy cost savings.
The indirect effects of the EEU are changes in the embodied energy rate and
the operations, maintenance, and disposal cost rates.
Both direct and indirect emplacement effects have rebound. 
as discussed below.
...
As shown in Table~\ref{tab:empeffect},
...
The first component of indirect rebound for the emplacement effect
...
$\left( \frac{\alc{E}_{emb}}{\bdev{E}_{emb}}
  \frac{\bdev{t}}{\alc{t}} - 1 \right) \rbdev{E}_{emb}$, 
