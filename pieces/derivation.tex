...
%------------------------------
\subsubsection{Direct substitution rebound ($Re_{dsub}$), approximate method} 
...
%------------------------------
\subsubsection{Indirect substitution rebound ($Re_{isub}$), approximate method} 
...
%------------------------------
\subsubsection{Direct substitution rebound ($Re_{dsub}$), exact method} 
...
%------------------------------
\subsubsection{Indirect substitution rebound ($Re_{isub}$), exact method} 
