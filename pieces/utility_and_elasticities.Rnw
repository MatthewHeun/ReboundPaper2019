...
unlikely to be worthwhile economically: 
the increased capital expense will overwhelm the financial savings, 
making it uneconomic to pursue small efficiency gains.
...
the income effect also employs elasticities.
...
Thereafter, the approximate and CES utility models are described.
Finally, elasticities for the substitution effect are 
discussed.
...
Due to homotheticity assumption,
