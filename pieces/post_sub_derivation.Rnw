...
<<ExamplePrefsPathGraph, echo=FALSE, fig.cap="Example preferences path graph.", fig.width=6, fig.height=4>>=
labels <- tibble::tribble(~x, ~y, ~lab, ~colour, ~size,
                          1.01, 1.0004, '""^scriptscriptstyle(o*",")*"*"', "black", 10,
                          0.95, 1.01, 'scriptscriptstyle(o)', "gray", 8,
                          # 1.13, 0.98, 'scriptscriptstyle(o)', "gray", 8,
                          0.95, 1.005, 'scriptscriptstyle("*")', "gray", 8,
                          # 1.2, 0.981, 'scriptscriptstyle("*")', "gray", 8,
                          1.155, 0.9815, 'scriptstyle("^")',  "black", 10,
                          0.95, 1.001, 'scriptscriptstyle("^")', "gray", 8,
                          # 1.17, 0.98, 'scriptscriptstyle("^")', "gray", 8,
                          1.185, 1.01, 'scriptscriptstyle("r")',  "gray", 8,
                          # 1.15, 0.98, 'scriptscriptstyle("r")',  "gray", 8,
