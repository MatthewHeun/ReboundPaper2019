...
\begin{tikzpicture}[font=\sffamily]
  ...
  \node[right=0.2cm of orig] (dev)[draw,rounded corners, fill=red!25!white] {\strut device};
  \node[right=0.2cm of dev] (prime) {$\adev{}$};
  \node[right=0.2cm of prime] (lc)[draw, align=center, rounded corners, fill=orange!25!white] {\strut lifecycle};
  \node[right=0.2cm of lc] (star) {$\alc{}$};
  \node[right=0.2cm of star] (sub)[draw,rounded corners, fill=yellow!25!white] {\strut substitution};
  \node[right=0.2cm of sub] (hat) {$\asub{~}$};
  \node[right=0.2cm of hat] (inc)[draw,rounded corners, fill=green!25!white] {\strut income};
  \node[right=0.2cm of inc] (bar) {$\ainc{~}$};
  \node[right=0.2cm of bar] (prod)[draw,rounded corners, fill=blue!25!white] {\strut productivity};
