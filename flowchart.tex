...
\begin{tikzpicture}[font=\sffamily]
  ...
  \node[right=0.2cm of orig] (dev)[draw,rounded corners, fill=device_color] {\strut device};
  \node[right=0.2cm of dev] (prime) {$\adev{}$};
  \node[right=0.2cm of prime] (lc)[draw, align=center, rounded corners, fill=lifecycle_color] {\strut lifecycle};
  \node[right=0.2cm of lc] (star) {$\alc{}$};
  \node[right=0.2cm of star] (sub)[draw,rounded corners, fill=substitution_color] {\strut substitution};
  \node[right=0.2cm of sub] (hat) {$\asub{~}$};
  \node[right=0.2cm of hat] (inc)[draw,rounded corners, fill=income_color] {\strut income};
  \node[right=0.2cm of inc] (bar) {$\ainc{~}$};
  \node[right=0.2cm of bar] (prod)[draw,rounded corners, fill=productivity_color] {\strut productivity};
