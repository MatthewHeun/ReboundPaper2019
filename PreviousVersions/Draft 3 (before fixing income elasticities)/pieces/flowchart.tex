...
\begin{tikzpicture}%[font=\sffamily]
  ...
  \node[right=0.2cm of orig] (empl)[rounded corners, fill=\emplcolor] {\strut emplacement};
  ...
  \node[right=0.2cm of bar] (prod)[rounded corners, fill=\macrocolor] {\strut productivity};
