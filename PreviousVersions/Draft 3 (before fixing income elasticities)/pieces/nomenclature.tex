...
\begin{tabular}{r l}
  ...
  $\eqspsC$ & energy service price ($p_s$) elasticity of energy service consumption ($\dot{q}_s$) [--] \\
  $\eqopsC$ & energy service price ($p_s$) elasticity of other goods consumption ($\dot{q}_o$) [--] \\
